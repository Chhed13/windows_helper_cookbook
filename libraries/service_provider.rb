...
class Chef::Provider::WindowsHelperService < Chef::Provider::Service::Windows
  ...
  def load_current_resource
    @current_resource = Chef::Resource::WindowsHelperService.new(@new_resource.name, nil)
  ...
  def config_same?
    ...
    #TODO: should check all parameters configuring (look at fill_config_hash)
